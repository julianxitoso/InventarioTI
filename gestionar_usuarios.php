...
// --- INICIO DEL CAMBIO: Array con la lista de cargos de la imagen ---
$cargos_disponibles_form = [
    ...
    'ASESOR COMERCIAL INTERNO QUINCENAL',
    'ASISTENTE ADMINISTRATIVO',
    'AUXILIAR DE BODEGA',
    'AUXILIAR DE CREDITO Y CARTERA',
    'AUXILIAR DE FACTURACION',
    'AUXILIAR DE NOMINA',
    'AUXILIAR DE SERVICIO AL CLIENTE',
    'AUXILIAR DE SERVICIO AL CLIENTE Y BODEGA',
    'AUXILIAR GESTION DOCUMENTAL',
    ...
    'COORDINADOR DE ATENCION AL CLIENTE CAC',
    'COORDINADOR DE COMPRAS',
    'COORDINADOR DE CREDITO Y CARTERA',
    ...
    'GERENTE DE SISTEMA INTEGRADO DE CALIDAD (SIC)',
    'GERENTE GENERAL',
    'GESTOR DE CARTERA',
    'JEFE DE BODEGA',
    'JEFE DE VENTAS',
    'LIDER DE ZONA',
    'MAYORDOMO',
    'PASANTE SENA ETAPA PRODUCTIVA',
    'PSICOLOGO ORGANIZACIONAL',
    'SECRETARIA',
    'SUPERNUMERARIO',
    'TESORERO (A)'
];
sort($cargos_disponibles_form); // Ordenamos alfabéticamente para una mejor visualización
// --- FIN DEL CAMBIO ---
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['crear_usuario_submit'])) {
        ...
        } elseif (!in_array($nuevo_cargo, $cargos_disponibles_form)) { // <-- Validación para el nuevo campo de cargo
    ...
    elseif (isset($_POST['editar_usuario_submit'])) {
        // ... (Tu código de actualización de usuario no necesita cambios en la lógica PHP para este requerimiento)
        // ... El valor de $_POST['edit_cargo'] vendrá correctamente del nuevo <select>
        // ... Solo asegúrate de agregar la validación del cargo como en el bloque de creación si lo deseas.
        ...
        if ($id_usuario_actualizar <= 0) {
            ...
            // El resto de tu lógica de actualización...
...
// ... (Tu código de LÓGICA GET no necesita cambios para este requerimiento) ...
...
// ... (Tu código para obtener la lista de usuarios no necesita cambios) ...
$usuarios_listados = [];
...
<head>
    ...
    .table th { white-space: nowrap; font-size: 1rem; font-weight: 500; color: #495057; background-color: #f8f9fa; border-top: none; border-bottom-width: 1px; }
    .table td { vertical-align: middle; font-size: 0.98rem; border-top: 1px solid #f1f1f1; }
...
<body>
    <div class="container-main container mt-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <button type="button" class="btn btn-principal btn-sm" data-bs-toggle="modal" data-bs-target="#modalCrearUsuario"><i class="bi bi-person-plus-fill"></i> Crear Nuevo Usuario</button>
        </div>
                                ...
                                <?php foreach ($usuarios_listados as $usuario_item): ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php if (strtolower($usuario_item['usuario']) !== 'admin' && $usuario_item['id'] !== 1): ?>
    ...
    <?php if ($usuario_para_editar): ?>
        <div class="modal fade" id="modalEditarUsuario" tabindex="-1" aria-labelledby="modalEditarUsuarioLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <form method="post" action="gestionar_usuarios.php" id="formEditarUsuarioAncla">
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        if(formCrear){
            ...
            formCrear.addEventListener('submit',function(event){validarClaveCrear();if(!this.checkValidity()){event.preventDefault();event.stopPropagation()}})
        }
        ...
        if(formEditar){
            ...
            formEditar.addEventListener('submit',function(event){if(editClave && editClave.value !== '' && editClave.value.length < 6){alert('La nueva contraseña debe tener al menos 6 caracteres.');editClave.focus();event.preventDefault();event.stopPropagation();return}validarClaveEditar();if(!this.checkValidity()){event.preventDefault();event.stopPropagation()}})
        }
