...
// Verificamos si todos los filtros principales están vacíos.
if (empty($q) && empty($tipo_activo) && empty($estado) && empty($regional) && empty($empresa) && empty($fecha_desde) && empty($fecha_hasta)) {
